                ...
                <div class="col">
                    <a target="_blank" rel="noopener noreferrer" href="<?php echo $video->video_url; ?>" class="text-decoration-none text-dark">
                        <div class="card h-100">
                            <img src="<?php echo $video->video_capa ?: 'https://via.placeholder.com/320x180.png?text=Sem+Capa'; ?>" class="card-img-top" style="height: 140px; object-fit: cover;">
                            <div class="card-body p-2">
                                ...
                                <a href="/news/video?id=<?php echo $video->video_id; ?>" class="btn btn-primary">Editar</a>
                                <a href="/news/videoDelete?id=<?php echo $video->video_id; ?>" class="btn btn-danger">Deletar</a>
                            </div>
                        </div>
                    </a>
                </div>
